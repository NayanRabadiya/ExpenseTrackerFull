// Root component: sets the axios base URL and declares every route,
// splitting public pages from the guarded /admin and /user sections.
...
// Point every axios call at the API. Baked in at build time, so changing
// VITE_API_BASE_URL needs a rebuild, not just a restart.
...
// Declares the toast container and the full route table.
function App() {
