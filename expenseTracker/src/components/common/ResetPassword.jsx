// "Reset password" page reached from the emailed link (/resetpassword/:token).
...
// New-password form; the one-hour token comes from the URL.
export const ResetPassword = () => {
  ...
  // Send the token plus the new password, then return to the login page.
