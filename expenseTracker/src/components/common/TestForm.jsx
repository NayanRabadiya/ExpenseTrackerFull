...
// Dev-only scratch form: the one caller of POST /user/url, the multipart
// registration endpoint that uploads a profile image to Cloudinary.
// Real signup uses Register.jsx and POST /user instead.
...
// Registration form that submits as multipart form data, image included.
export const TestForm = () => {
    ...
    // Build a FormData payload and POST it to /user/url.
