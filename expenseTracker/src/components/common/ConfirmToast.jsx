// A yes/no confirmation dialog built on react-toastify, used before deletes.
import { toast } from "react-toastify";
import React, { useEffect, useRef } from "react";
import "../styles/toast.css"; // Your custom styles

// The dialog body: traps Tab focus between Yes/No and treats Escape as "No".
const ConfirmToastContent = ({ message, resolve, closeToast }) => {
  ...
  // Settle the promise with the button pressed, then dismiss the toast.
...
// Show the dialog and return a Promise<boolean> of the user's choice,
// so callers can `await ConfirmToast("Delete this?")`.
