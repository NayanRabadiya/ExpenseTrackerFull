...
// Signup page. Always creates a standard user — admins are promoted in the DB.
export const Register = () => {
  ...
  // Build the payload with the standard-user role id and create the account.
      ...
      <div className="register-container">
        <div className="register-card">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="input-wrapper">
              <input id="contact" type="text" placeholder="Enter contact no." autoComplete="phone" className={errors.contact && "input-error"}
