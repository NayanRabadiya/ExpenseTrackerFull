// User profile page: view/edit your details and profile picture, plus logout.
// Seeds itself from the userData cached at login, then PUTs changes as form data.
...
// Editable profile card for the logged-in user.
