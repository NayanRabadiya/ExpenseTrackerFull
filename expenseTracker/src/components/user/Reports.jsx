// Reports page: pie/bar charts of spend vs budget, which can be rendered to a
// PDF (via html2canvas + jsPDF) to view in a tab or email to the user.
...
// Month/year filtered charts plus the PDF view and email actions.
export const Reports = () => {
  ...
  // Snapshot the report to an A4 PDF and open it in a new browser tab.
  const handleViewPdf = () => {
    toast.promise(async () => {
  ...
  // Snapshot the report to a PDF and upload it so the API can email it.
