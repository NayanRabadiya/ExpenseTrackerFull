// "Add expense" form. Converts the date input's yyyy-mm-dd into the
// dd/mm/yyyy string the API stores.
...
export const ExpenseForm = () => {
  ...
  // Fill the category dropdown from the list the dashboard cached.
  ...
  // Reformat the date to dd/mm/yyyy, attach the user id, and POST the expense.
    ...
    <div className="expense-container">
      <div className="expense-card">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <textarea {...register("description")} placeholder="Add description..." rows="2"></textarea>
