...
// Summary cards for total budget, spend, and what's remaining.
export const Dashboard = () => {
  ...
  // Load this user's budgets and total. The API answers 404 when they have
  // none yet, which lands in the catch below and leaves the totals unset.
  ...
  // Cache the category list for the expense/budget forms to read.
  ...
  // Load this user's expenses; also 404s when they have none yet.
