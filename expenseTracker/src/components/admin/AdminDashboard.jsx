// Admin dashboard: site-wide stats for the current month, straight from
// GET /admindata — user count, total spend, and the category breakdown.
...
// Stat cards and charts built from the /admindata response.
export const AdminDashboard = () => {
  ...
  // Fetch the dashboard stats; on failure the zeroed defaults above stay put.
