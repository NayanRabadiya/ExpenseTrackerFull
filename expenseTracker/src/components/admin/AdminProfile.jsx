// Admin profile page — the admin-side twin of user/Profile.jsx: view/edit your
// own details and picture, plus logout. Uses the same PUT /user/{id} endpoint.
...
// Editable profile card for the logged-in admin.
