// Admin user management: search users, change a user's role, and delete users.
// Deleting a user also removes their expenses and budgets.
...
// Paged, searchable user table with inline role editing.
export const Users = () => {
  // Dummy User Data — sample rows kept for reference; not rendered.
  const usersk = [
  ...
  // Load the role list that populates the role dropdown.
  ...
  // Save the user's new role and patch that row in place.
  ...
  // Confirm, then delete the user plus their expenses and budgets.
  ...
  // Apply the search text and role filter, always hiding your own account.
  useEffect(() => {
  ...
  // Pagination Logic
  // Move the table to another page.
